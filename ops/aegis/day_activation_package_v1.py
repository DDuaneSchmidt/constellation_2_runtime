...
from constellation_2.common.day_activation_authority_v1 import run_day_activation_authority_v1
...
PRODUCER_ID = "ops/tools/build_day_activation_package_v1.py"
PRODUCER_VERSION = "v1"


def build_and_write_day_activation_package_v1(
    *,
    truth_root: Path | str,
    day_utc: str,
    ...
    # Existing authority resolves canonical/execution roots from runtime contracts; truth_root is kept for CLI/API symmetry.
    repo_root = Path(__file__).resolve().parents[2]
    result = run_day_activation_authority_v1(
        repo_root=repo_root,
