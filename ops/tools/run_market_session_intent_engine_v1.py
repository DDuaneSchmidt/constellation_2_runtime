...
def run_scan_cycle_v1(
    *,
    ...
    portfolio_scoring = build_portfolio_scoring_v1(
        day_utc=day_utc,
        truth_root=truth_root,
        environment=environment,
        source_rollup_path=rollup_path,
        portfolio_gate_path_arg=Path(str(portfolio_gate.get("artifact_path") or "")),
    )
    ...
    arbitration_raw = build_intent_arbitration(
        ...
        portfolio_scoring_path_arg=Path(str(portfolio_scoring.get("artifact_path") or "")),
    )
