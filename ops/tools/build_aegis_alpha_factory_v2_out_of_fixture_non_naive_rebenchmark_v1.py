...
def main() -> int:
    parser = argparse.ArgumentParser(description="Build Aegis Alpha Factory v2 out-of-fixture non-naive rebenchmark V1.")
    parser.add_argument("--truth-root", "--truth_root", dest="truth_root", required=True)
    parser.add_argument("--day", required=True)
    args = parser.parse_args()

    payload = build_alpha_factory_v2_out_of_fixture_non_naive_rebenchmark_v1(
    ...
    print("AEGIS ALPHA FACTORY V2 OUT-OF-FIXTURE NON-NAIVE REBENCHMARK v1")
