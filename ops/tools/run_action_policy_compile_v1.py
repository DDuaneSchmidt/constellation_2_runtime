...
def main() -> int:
    parser = argparse.ArgumentParser(description='Compile action_intent_v1 from governed advisor execution inputs')
    ...
    _write_json(out_path, action_intent.to_dict())
    print(f'OK: ACTION_INTENT_WRITTEN path={out_path}')
    return 0
