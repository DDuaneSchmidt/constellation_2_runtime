...
from constellation_2.common.exit_execution_request_v1 import (
...
def main(argv: list[str] | None = None) -> int:
    ap = argparse.ArgumentParser(prog="run_exit_execution_request_v1")
    ...
    owner_run_id = f"exit_execution_request_v1:{args.day_utc}:{args.position_id}"
    append_result = append_runtime_ledger_events_v1(
        truth_root=truth_root,
        day_utc=args.day_utc,
        events=[
            {
                "event_type": "EXIT_EXECUTION_REQUESTED",
                "produced_utc": now_utc_iso_v1(),
                "owner_plane": "EXECUTION_PLANE",
                "owner_tool": "ops/tools/run_exit_execution_request_v1.py",
                ...
                "identity_key": f"{session_id}:EXIT_EXECUTION_REQUEST:{args.position_id}",
                "identity_tuple": {
                    "day_utc": args.day_utc,
                    "owner_plane": "EXECUTION_PLANE",
                    "owner_run_id": owner_run_id,
        ...
        json.dumps(
            {
                ...
                "runtime_ledger_projection": projection_over_runtime_ledger_v1(
                    ...
                    projection_notice="Exit execution requests are canonical runtime handoff truth; this envelope is a projection.",
                ),
            },
            sort_keys=True,
        )
