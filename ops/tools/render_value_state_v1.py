...
from constellation_2.common.value_state_kernel_v1 import list_value_states_v1  # noqa: E402
...
def main() -> int:
    ...
    rows = [dict(ref.payload) for ref in list_value_states_v1(canonical_truth_root=args.canonical_truth_root, day_utc=args.day_utc, scope_id=args.scope_id)]
    if not rows:
        raise SystemExit("VALUE_STATE_ARTIFACT_MISSING")
