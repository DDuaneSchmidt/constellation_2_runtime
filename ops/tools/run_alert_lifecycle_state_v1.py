...
from constellation_2.aegis_truth.state_machines.alert_lifecycle_state_v1 import write_alert_lifecycle_state
...
def main() -> int:
    ...
    args = ap.parse_args()
    path = write_alert_lifecycle_state(target_day=args.target_day, truth_root=args.truth_root, environment=args.environment)
