...
SCHEMA = "governance/04_DATA/SCHEMAS/C2/REPORTS/market_data_authority.v1.schema.json"
...
def main(argv: list[str] | None = None) -> int:
    ...
    parser = argparse.ArgumentParser(prog="run_market_data_authority_v1")
        ...
        json.dumps(
            {
                ...
                "market_data_state": payload["market_data_state"],
                "operator_impact": payload["operator_impact"],
                "required_symbols": payload["required_symbols"],
