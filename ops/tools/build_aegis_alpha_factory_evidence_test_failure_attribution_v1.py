...
def main() -> int:
    parser = argparse.ArgumentParser(description="Build Aegis Alpha Factory evidence test failure attribution V1.")
    parser.add_argument("--truth-root", "--truth_root", dest="truth_root", required=True)
    parser.add_argument("--day", required=True)
    args = parser.parse_args()
    payload = build_alpha_factory_evidence_test_failure_attribution_v1(
    ...
    print("AEGIS ALPHA FACTORY EVIDENCE TEST FAILURE ATTRIBUTION v1")
