...
def main() -> int:
    parser = argparse.ArgumentParser(description="Build Aegis outcome performance metrics v1")
    ...
    payload = build_outcome_performance_metrics_v1(truth_root=Path(args.truth_root), day_utc=args.day)
    path = write_outcome_performance_metrics_v1(truth_root=Path(args.truth_root), day_utc=args.day, payload=payload)
