...
from constellation_2.common.trade_lineage_graph_v1 import (
    evaluate_trade_lineage_graph_v1,
    write_trade_lineage_graph_v1,
)
from constellation_2.phaseD.lib.validate_against_schema_v1 import validate_against_repo_schema_v1
from ops.tools.c2_account_resolution_v1 import resolve_single_paper_ib_account_from_sleeve_registry


SCHEMA = "governance/04_DATA/SCHEMAS/C2/REPORTS/trade_lineage_graph.v1.schema.json"
...
def main(argv: list[str] | None = None) -> int:
    ...
    parser = argparse.ArgumentParser(prog="run_trade_lineage_graph_v1")
    ...
    output_path = write_trade_lineage_graph_v1(
        truth_root=truth_root,
        day_utc=day_utc,
        payload=payload,
    )
        ...
        json.dumps(
            {
                ...
                "broken_edge_count": payload["broken_edge_count"],
