...
def main() -> int:
    parser = argparse.ArgumentParser(description="Project current operator status from certified control-plane truth.")
    ...
    try:
        report = materialize_control_plane_operator_status_v1(
