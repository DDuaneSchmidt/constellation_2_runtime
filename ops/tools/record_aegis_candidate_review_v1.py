...
from ops.aegis.candidate_lifecycle_v1 import append_candidate_review_action_v1  # noqa: E402
from ops.aegis.runtime_truth_kernel_v1 import DEFAULT_TRUTH_ROOT  # noqa: E402


def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(prog="record_aegis_candidate_review_v1")
    ...
    parser.add_argument("--action", required=True, choices=["watchlist", "dismiss", "needs-more-evidence", "add-note"])
