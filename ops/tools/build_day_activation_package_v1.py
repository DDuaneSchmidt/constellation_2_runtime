...
from ops.aegis.day_activation_package_v1 import build_and_write_day_activation_package_v1


def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(prog="build_day_activation_package_v1")
    ...
    result = build_and_write_day_activation_package_v1(
