...
def _build_paper_status(
    ...
    section_lines = [
        ...
        f"- market_open_data_gate_snapshot_path: {market_open_gate_payload.get('snapshot_path', '')}",
        f"- market_open_data_gate_freshness_certificate_path: {market_open_gate_payload.get('freshness_certificate_path', '')}",
        f"- market_open_data_gate_snapshot_age_seconds: {market_open_gate_payload.get('snapshot_age_seconds', '')}",
        f"- market_open_data_gate_capture_attempted_by_gate: {market_open_gate_payload.get('capture_attempted_by_gate', '')}",
        f"- market_open_data_gate_capture_result: {json.dumps(market_open_gate_payload.get('capture_result') or {}, sort_keys=True)}",
        f"- market_open_data_gate_operator_next_action: {market_open_gate_payload.get('operator_next_action', '')}",
