...
def main() -> int:
    parser = argparse.ArgumentParser(description='Emit capability_schedule_v1')
    ...
    artifact = build_capability_schedule(planning_snapshot=planning, module_maturity_map={'spending_policy': 'action_policy_allowed', 'income_floor_timeline': 'action_policy_allowed', 'tax_budget': 'recommendation_support_only', 'recommendation_comparison': 'recommendation_support_only', 'monitoring_replan': 'monitored_plan_allowed', 'readiness': 'observational_only', 'quarterly_action_summary': 'observational_only', 'plan_health': 'observational_only', 'why_not': 'observational_only', 'decision_memo': 'observational_only', 'household_timeline': 'observational_only', 'stress_case_view': 'observational_only'}, prerequisite_map={'recommendation_comparison': ('spending_policy', 'income_floor_timeline', 'tax_budget'), 'decision_memo': ('plan_health', 'why_not')}, metadata=metadata)
    out = _write(_runtime_path(args.output_root, args.mode, 'capability_schedule_v1', args.day_utc, 'capability_schedule.v1.json'), artifact.to_dict())
    print(f'OK: {out}')
    return 0
