...
from constellation_2.aegis_truth.state_machines.trading_readiness_state_v1 import write_trading_readiness_state
...
def main() -> int:
    ...
    args = ap.parse_args()
    path = write_trading_readiness_state(target_day=args.target_day, truth_root=args.truth_root, environment=args.environment)
