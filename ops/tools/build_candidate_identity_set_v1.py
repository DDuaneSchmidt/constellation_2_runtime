...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(prog="build_candidate_identity_set_v1")
    ...
    payload, path = build_and_write_candidate_identity_set_v1(
    ...
    print(json.dumps({
        ...
        "actual_phasec_order_plan": payload.get("actual_phasec_order_plan"),
        "stale_order_plan_reason": payload.get("stale_order_plan_reason"),
