...
from ops.aegis.research_lab.research_pipeline_v1 import REVIEW_DECISIONS, append_research_review_decision_v1  # noqa: E402
from ops.aegis.runtime_truth_kernel_v1 import DEFAULT_TRUTH_ROOT  # noqa: E402


def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(prog="record_aegis_research_review_decision_v1")
    ...
    event = append_research_review_decision_v1(
