...
def main() -> int:
    parser = argparse.ArgumentParser(description='Invoke canonical advisor_execution decision plan path')
    ...
    action_intent = canonical_dir / 'action_intent.v1.json'
    decision_plan = canonical_dir / 'decision_plan.v1.json'
    _call('run_action_policy_compile_v1.py', ['--planning_snapshot_json', args.planning_snapshot_json, '--official_recommendation_set_json', args.official_recommendation_set_json, '--action_policy_pack_json', args.action_policy_pack_json, '--out_json', str(action_intent)])
    _call('run_decision_plan_build_v1.py', ['--planning_snapshot_json', args.planning_snapshot_json, '--official_recommendation_set_json', args.official_recommendation_set_json, '--action_policy_pack_json', args.action_policy_pack_json, '--action_intent_json', str(action_intent), '--out_json', str(decision_plan)])
    print(f'OK: {decision_plan}')
    return 0
