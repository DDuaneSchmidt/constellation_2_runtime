...
from constellation_2.common.advisor_kernel.stress_case_view_service import build_stress_case_view


def main() -> int:
    parser = argparse.ArgumentParser(description='Emit stress_case_view_v1')
    ...
    artifact = build_stress_case_view(planning_snapshot=planning, metadata=metadata)
    out = _write(_runtime_path(args.output_root, args.mode, 'stress_case_view_v1', args.day_utc, 'stress_case_view.v1.json'), artifact.to_dict())
    print(f'OK: {out}')
    return 0
