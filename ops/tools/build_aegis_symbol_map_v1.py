...
from ops.aegis.market_data.symbol_map_v1 import build_symbol_map_v1, write_symbol_map_v1  # noqa: E402
from ops.aegis.runtime_truth_kernel_v1 import DEFAULT_TRUTH_ROOT  # noqa: E402


def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(prog="build_aegis_symbol_map_v1")
