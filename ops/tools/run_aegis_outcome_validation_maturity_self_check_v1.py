...
def main() -> int:
    parser=argparse.ArgumentParser(prog="run_aegis_outcome_validation_maturity_self_check_v1")
    ...
    payload=build_outcome_validation_maturity_self_check_v1(truth_root=Path(args.truth_root), day_utc=str(args.day))
    path=write_outcome_validation_maturity_self_check_v1(truth_root=Path(args.truth_root), day_utc=str(args.day), payload=payload)
