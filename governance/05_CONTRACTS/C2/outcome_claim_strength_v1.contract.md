---
id: C2_OUTCOME_CLAIM_STRENGTH_V1
title: "C2 Outcome Claim Strength Contract v1"
status: DRAFT
version: 1
...
- `insufficient_evidence` applies when realized basis or linkage is incomplete.
...
- `direct_attribution` applies only when explicit governed evidence directly binds prior governed state to realized result.
