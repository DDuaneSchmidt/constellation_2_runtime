...
- target: `15:35 America/New_York`
- calendar: `OnCalendar=Mon..Fri *-*-* 15:35:00 America/New_York`
...
The systemd calendar wakes on weekdays at 15:35 ET. The producer also reads governed `market_calendar_v1/NYSE/<year>.jsonl`; if the day is not a NYSE trading session or the calendar is missing, it writes an advisory/not-ready Lite report with no executable queue items.
