# BACKTEST_003 Data and Baseline Specification

# IMP_003 — Turtle Breakout

## Purpose

Freeze data, baseline, and reproducibility assumptions for BACKTEST_003.

## Data Source

Use the same data source hierarchy established for BACKTEST_001 and BACKTEST_002:
...
Fixed random seed
Preserve approximate time-in-market of IMP_003
Report median, 5th percentile, 95th percentile
Report IMP_003 percentile rank versus random distribution
```
...
BACKTEST_003 may be authorized only after this specification exists.
