...
Aegis Lite runs once per trading day near 15:30-15:45 ET. It evaluates promoted sleeves only, classifies regime, generates candidate trades, performs edge-overlap review, applies governance, and writes a complete manual execution report plus `manual_trade_packet.v1`. It does not submit orders or enable transmit.
