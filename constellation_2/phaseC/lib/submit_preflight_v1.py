...
Supported paths:
- Options: options_intent.v2 + order_plan.v1 + mapping_ledger_record.v1 + binding_record.v1 + chain + freshness
- Equity:  equity_intent.v1  + equity_order_plan.v1 + mapping_ledger_record.v2 + binding_record.v2
"""
