#!/usr/bin/env python3
"""
c2_submit_paper_v4.py

Bootstrap-safe tool wrapper for submit_boundary_paper_v3.
Supports equity_order_plan.v2 identity sets.

Usage:
  python3 constellation_2/phaseD/tools/c2_submit_paper_v4.py --help
"""
...
def main() -> int:
    ap = argparse.ArgumentParser(prog="c2_submit_paper_v4")
    ...
    rc = run_submit_boundary_paper_v3(
