...
from .common import SLEEVE_TRUTH_ROOT, evidence_ref, freshness_state, latest_timestamp, read_json_dict, resolve_ui_day
...
def build_orders_view(day: Optional[str] = None) -> Dict[str, Any]:
    ...
    source_authority = ["execution_evidence_v1", "fill_ledger_v1"]
