...
SCHEMA_FILENAME = "accounting_failure.v1.schema.json"


def main() -> None:
    ap = argparse.ArgumentParser(description="Validate C2 accounting failure artifact v1 against governed schema.")
    ap.add_argument("--path", required=True, help="Path to failure.json")
    args = ap.parse_args()
