...
SCHEMA_FILENAME = "accounting_exposure.v1.schema.json"


def main() -> None:
    ap = argparse.ArgumentParser(description="Validate C2 accounting exposure artifact v1 against governed schema.")
    ap.add_argument("--path", required=True, help="Path to exposure.json")
    args = ap.parse_args()
