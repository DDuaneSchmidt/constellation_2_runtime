"""
test_trend_eq_primary_determinism_v1.py

Audit-grade determinism test for Trend Equity Primary ExposureIntent emitter.
...
class TestTrendEqPrimaryDeterminismV1(unittest.TestCase):
