        ...
        rows.append(
            {
                ...
                "generated_at": str(raw.get("generated_at") or raw.get("generated_at_utc") or generated_at_utc),
                "created_at": str(raw.get("created_at") or raw.get("generated_at") or raw.get("generated_at_utc") or generated_at_utc),
                ...
                "sizing_guidance": normalized["sizing_guidance"],
                "risk_per_trade": normalized["risk_per_trade"],
                ...
                "operator_review_status": str(raw.get("operator_review_status") or "AWAITING_OPERATOR_REVIEW"),
                "automatic_approval_allowed": False,
                "broker_execution_allowed": False,
                "autonomous_execution_allowed": False,
                "raw_signal_id": str(raw.get("raw_signal_id") or raw.get("intent_id") or ""),
                "intent_id": str(raw.get("intent_id") or raw.get("raw_signal_id") or ""),
                "promotion_contract": raw.get("promotion_contract") if isinstance(raw.get("promotion_contract"), dict) else {},
                "reason_codes": normalized["reason_codes"],
                "source_artifact_refs": raw.get("source_artifact_refs") if isinstance(raw.get("source_artifact_refs"), list) else [],
