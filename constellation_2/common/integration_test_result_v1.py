...
def _validate_semantics(obj: dict[str, Any]) -> None:
    ...
    validate_test_result_entry_v1(obj, result_type="integration_test_result")


@dataclass(frozen=True, slots=True)
class IntegrationTestResultV1:
    schema_id: str
    schema_version: str
    result_id: str
    ...
    @classmethod
    def from_dict(cls, obj: dict[str, Any]) -> "IntegrationTestResultV1":
...
def build_integration_test_result_v1(
    *,
    result_id: str,
    subsystem_name: str,
    status: str,
...
) -> IntegrationTestResultV1:
    obj: dict[str, Any] = {
        "schema_id": "integration_test_result",
        "schema_version": "v1",
        "result_id": str(result_id),
        "subsystem_name": str(subsystem_name),
        "result_type": "integration_test_result",
        "status": str(status),
    ...
    return IntegrationTestResultV1.from_dict(obj)
