...
def _validate_semantics(obj: dict[str, Any]) -> None:
    ...
    validate_test_result_entry_v1(obj, result_type="replay_test_result")


@dataclass(frozen=True, slots=True)
class ReplayTestResultV1:
    schema_id: str
    schema_version: str
    result_id: str
    ...
    @classmethod
    def from_dict(cls, obj: dict[str, Any]) -> "ReplayTestResultV1":
...
def build_replay_test_result_v1(
    *,
    result_id: str,
    subsystem_name: str,
    status: str,
    ...
    obj: dict[str, Any] = {
        "schema_id": "replay_test_result",
        "schema_version": "v1",
        "result_id": str(result_id),
        "subsystem_name": str(subsystem_name),
        "result_type": "replay_test_result",
        "status": str(status),
    ...
    return ReplayTestResultV1.from_dict(obj)
