...
COMPARISON_VERSION = "constellation_2.common.value_comparison_v1"
SUPPORTED_COMPARISON_TYPES = ("blocked_vs_allowed",)


def evaluate_value_comparison_v1(
    *,
    ...
    if normalized == "not_requested":
        return {
            ...
            "reason_id": "VALUE_COMPARISON_NOT_REQUESTED",
    ...
    if normalized not in SUPPORTED_COMPARISON_TYPES:
        return {
            ...
            "reason_id": "VALUE_COMPARISON_UNSUPPORTED_TYPE",
    ...
    if (
        ...
        return {
            ...
            "reason_id": "VALUE_BLOCKED_WINDOW_NO_ACTIVITY",
            "allowed_claim_strength": "bounded_association",
        }
    return {
        "comparison_type": "blocked_vs_allowed",
        "comparison_status": "rejected",
        "reason_id": "VALUE_BLOCKED_COMPARISON_BASIS_MISSING",
        "allowed_claim_strength": "insufficient_evidence",
    }
