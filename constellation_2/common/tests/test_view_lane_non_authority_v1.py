...
def test_view_lane_authority() -> None:
    ...
    artifact = build_household_timeline(planning_snapshot=snapshot, metadata=meta)
    assert artifact.authority_class == 'view_authority'
