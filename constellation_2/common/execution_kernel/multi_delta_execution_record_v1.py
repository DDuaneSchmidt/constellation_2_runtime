...
SCHEMA_RELPATH = 'governance/04_DATA/SCHEMAS/C2/EXECUTION/multi_delta_execution_record.v1.schema.json'


@dataclass(frozen=True, slots=True)
class MultiDeltaExecutionRecordV1:
    schema_id: str
    schema_version: str
    record_id: str
    ...
    @classmethod
    def from_dict(cls, obj: dict[str, Any]) -> 'MultiDeltaExecutionRecordV1':
    ...
    @classmethod
    def load_file(cls, path: str | Path) -> 'MultiDeltaExecutionRecordV1':
