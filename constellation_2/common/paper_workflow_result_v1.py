...
def _validate_semantics(obj: dict[str, Any]) -> None:
    ...
    validate_test_result_entry_v1(obj, result_type="paper_workflow_result")


@dataclass(frozen=True, slots=True)
class PaperWorkflowResultV1:
    schema_id: str
    schema_version: str
    result_id: str
    ...
    @classmethod
    def from_dict(cls, obj: dict[str, Any]) -> "PaperWorkflowResultV1":
...
def build_paper_workflow_result_v1(
    *,
    result_id: str,
    subsystem_name: str,
    status: str,
...
) -> PaperWorkflowResultV1:
    obj: dict[str, Any] = {
        "schema_id": "paper_workflow_result",
        "schema_version": "v1",
        "result_id": str(result_id),
        "subsystem_name": str(subsystem_name),
        "result_type": "paper_workflow_result",
        "status": str(status),
    ...
    return PaperWorkflowResultV1.from_dict(obj)
