...
def _validate_semantics(obj: dict[str, Any]) -> None:
    ...
    validate_test_result_entry_v1(obj, result_type="runtime_truth_integrity_result")


@dataclass(frozen=True, slots=True)
class RuntimeTruthIntegrityResultV1:
    schema_id: str
    schema_version: str
    result_id: str
    ...
    @classmethod
    def from_dict(cls, obj: dict[str, Any]) -> "RuntimeTruthIntegrityResultV1":
...
def build_runtime_truth_integrity_result_v1(
    *,
    result_id: str,
    subsystem_name: str,
    status: str,
...
) -> RuntimeTruthIntegrityResultV1:
    obj: dict[str, Any] = {
        "schema_id": "runtime_truth_integrity_result",
        "schema_version": "v1",
        "result_id": str(result_id),
        "subsystem_name": str(subsystem_name),
        "result_type": "runtime_truth_integrity_result",
        "status": str(status),
    ...
    return RuntimeTruthIntegrityResultV1.from_dict(obj)
