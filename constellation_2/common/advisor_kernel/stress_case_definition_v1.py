...
SCHEMA_RELPATH = 'governance/04_DATA/SCHEMAS/C2/ADVISOR_KERNEL/stress_case_definition.v1.schema.json'
...
class StressCaseDefinitionV1:
    ...
    @classmethod
    def from_dict(cls, obj: dict[str, Any]) -> 'StressCaseDefinitionV1':
    ...
    @classmethod
    def load_file(cls, path: str | Path) -> 'StressCaseDefinitionV1':
