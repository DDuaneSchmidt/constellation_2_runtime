...
SCHEMA_RELPATH = 'governance/04_DATA/SCHEMAS/C2/ADVISOR_KERNEL/decision_option.v1.schema.json'
...
class DecisionOptionV1:
    ...
    @classmethod
    def from_dict(cls, obj: dict[str, Any]) -> 'DecisionOptionV1':
    ...
    @classmethod
    def load_file(cls, path: str | Path) -> 'DecisionOptionV1':
