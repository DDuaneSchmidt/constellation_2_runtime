...
SCHEMA_RELPATH = 'governance/04_DATA/SCHEMAS/C2/ADVISOR_KERNEL/semantic_reconciliation_report.v1.schema.json'
...
class SemanticReconciliationReportV1:
    schema_id: str
    schema_version: str
    authority_class: str
    support_status: str
    ...
    @classmethod
    def from_dict(cls, obj: dict[str, Any]) -> 'SemanticReconciliationReportV1':
    ...
    @classmethod
    def load_file(cls, path: str | Path) -> 'SemanticReconciliationReportV1':
