...
SCHEMA_RELPATH = 'governance/04_DATA/SCHEMAS/C2/ADVISOR_KERNEL/stress_case_outcome.v1.schema.json'
...
class StressCaseOutcomeV1:
    ...
    @classmethod
    def from_dict(cls, obj: dict[str, Any]) -> 'StressCaseOutcomeV1':
    ...
    @classmethod
    def load_file(cls, path: str | Path) -> 'StressCaseOutcomeV1':
