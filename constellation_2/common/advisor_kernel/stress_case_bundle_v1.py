...
SCHEMA_RELPATH = 'governance/04_DATA/SCHEMAS/C2/ADVISOR_KERNEL/stress_case_bundle.v1.schema.json'
...
class StressCaseBundleV1:
    ...
    @classmethod
    def from_dict(cls, obj: dict[str, Any]) -> 'StressCaseBundleV1':
    ...
    @classmethod
    def load_file(cls, path: str | Path) -> 'StressCaseBundleV1':
