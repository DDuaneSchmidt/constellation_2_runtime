...
SCHEMA_RELPATH = 'governance/04_DATA/SCHEMAS/C2/ADVISOR_KERNEL/tradeoff_matrix.v1.schema.json'
...
class TradeoffMatrixV1:
    ...
    @classmethod
    def from_dict(cls, obj: dict[str, Any]) -> 'TradeoffMatrixV1':
    ...
    @classmethod
    def load_file(cls, path: str | Path) -> 'TradeoffMatrixV1':
