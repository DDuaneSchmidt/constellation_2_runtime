...
SCHEMA_RELPATH = 'governance/04_DATA/SCHEMAS/C2/ADVISOR_KERNEL/phase_transition_rule.v1.schema.json'
...
class PhaseTransitionRuleV1:
    ...
    @classmethod
    def from_dict(cls, obj: dict[str, Any]) -> 'PhaseTransitionRuleV1':
    ...
    @classmethod
    def load_file(cls, path: str | Path) -> 'PhaseTransitionRuleV1':
