...
SCHEMA_RELPATH = 'governance/04_DATA/SCHEMAS/C2/ADVISOR_KERNEL/income_source_registry.v1.schema.json'
...
class IncomeSourceRegistryV1:
    ...
    @classmethod
    def from_dict(cls, obj: dict[str, Any]) -> 'IncomeSourceRegistryV1':
    ...
    @classmethod
    def load_file(cls, path: str | Path) -> 'IncomeSourceRegistryV1':
