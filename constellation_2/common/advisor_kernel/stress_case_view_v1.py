...
SCHEMA_RELPATH = 'governance/04_DATA/SCHEMAS/C2/ADVISOR_KERNEL/stress_case_view.v1.schema.json'
...
class StressCaseViewV1:
    ...
    scenario_ids: tuple[Any, ...]
    outcomes: tuple[Any, ...]
    summary: str

    @classmethod
    def from_dict(cls, obj: dict[str, Any]) -> 'StressCaseViewV1':
        ...
        return cls(
            ...
            scenario_ids=tuple(obj['scenario_ids']),
            outcomes=tuple(obj['outcomes']),
            summary=str(obj['summary']),
        )

    @classmethod
    def load_file(cls, path: str | Path) -> 'StressCaseViewV1':
