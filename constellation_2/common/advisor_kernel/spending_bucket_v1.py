...
SCHEMA_RELPATH = 'governance/04_DATA/SCHEMAS/C2/ADVISOR_KERNEL/spending_bucket.v1.schema.json'
...
class SpendingBucketV1:
    ...
    @classmethod
    def from_dict(cls, obj: dict[str, Any]) -> 'SpendingBucketV1':
    ...
    @classmethod
    def load_file(cls, path: str | Path) -> 'SpendingBucketV1':
