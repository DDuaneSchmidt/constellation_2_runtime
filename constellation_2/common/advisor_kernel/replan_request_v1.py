...
SCHEMA_RELPATH = 'governance/04_DATA/SCHEMAS/C2/ADVISOR_KERNEL/replan_request.v1.schema.json'
...
class ReplanRequestV1:
    ...
    @classmethod
    def from_dict(cls, obj: dict[str, Any]) -> 'ReplanRequestV1':
    ...
    @classmethod
    def load_file(cls, path: str | Path) -> 'ReplanRequestV1':
