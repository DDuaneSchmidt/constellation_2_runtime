...
SCHEMA_RELPATH = 'governance/04_DATA/SCHEMAS/C2/ADVISOR_KERNEL/decision_comparison_set.v1.schema.json'
...
class DecisionComparisonSetV1:
    ...
    option_ids: tuple[Any, ...]
    support_basis: str
    reason_codes: tuple[Any, ...]

    @classmethod
    def from_dict(cls, obj: dict[str, Any]) -> 'DecisionComparisonSetV1':
        ...
        return cls(
            ...
            option_ids=tuple(obj['option_ids']),
            support_basis=str(obj['support_basis']),
            reason_codes=tuple(obj['reason_codes']),
        )

    @classmethod
    def load_file(cls, path: str | Path) -> 'DecisionComparisonSetV1':
