...
SCHEMA_RELPATH = 'governance/04_DATA/SCHEMAS/C2/ADVISOR_KERNEL/spending_drift_report.v1.schema.json'
...
class SpendingDriftReportV1:
    ...
    @classmethod
    def from_dict(cls, obj: dict[str, Any]) -> 'SpendingDriftReportV1':
    ...
    @classmethod
    def load_file(cls, path: str | Path) -> 'SpendingDriftReportV1':
