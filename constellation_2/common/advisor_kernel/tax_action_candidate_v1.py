...
SCHEMA_RELPATH = 'governance/04_DATA/SCHEMAS/C2/ADVISOR_KERNEL/tax_action_candidate.v1.schema.json'
...
class TaxActionCandidateV1:
    ...
    @classmethod
    def from_dict(cls, obj: dict[str, Any]) -> 'TaxActionCandidateV1':
    ...
    @classmethod
    def load_file(cls, path: str | Path) -> 'TaxActionCandidateV1':
