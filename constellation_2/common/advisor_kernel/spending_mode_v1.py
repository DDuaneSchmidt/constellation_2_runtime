...
SCHEMA_RELPATH = 'governance/04_DATA/SCHEMAS/C2/ADVISOR_KERNEL/spending_mode.v1.schema.json'
...
class SpendingModeV1:
    ...
    @classmethod
    def from_dict(cls, obj: dict[str, Any]) -> 'SpendingModeV1':
    ...
    @classmethod
    def load_file(cls, path: str | Path) -> 'SpendingModeV1':
