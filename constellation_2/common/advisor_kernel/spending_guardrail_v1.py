...
SCHEMA_RELPATH = 'governance/04_DATA/SCHEMAS/C2/ADVISOR_KERNEL/spending_guardrail.v1.schema.json'
...
class SpendingGuardrailV1:
    ...
    @classmethod
    def from_dict(cls, obj: dict[str, Any]) -> 'SpendingGuardrailV1':
    ...
    @classmethod
    def load_file(cls, path: str | Path) -> 'SpendingGuardrailV1':
