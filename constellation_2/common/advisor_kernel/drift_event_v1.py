...
SCHEMA_RELPATH = 'governance/04_DATA/SCHEMAS/C2/ADVISOR_KERNEL/drift_event.v1.schema.json'
...
class DriftEventV1:
    ...
    @classmethod
    def from_dict(cls, obj: dict[str, Any]) -> 'DriftEventV1':
    ...
    @classmethod
    def load_file(cls, path: str | Path) -> 'DriftEventV1':
