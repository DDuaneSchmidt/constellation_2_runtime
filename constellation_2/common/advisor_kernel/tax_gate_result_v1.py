...
SCHEMA_RELPATH = 'governance/04_DATA/SCHEMAS/C2/ADVISOR_KERNEL/tax_gate_result.v1.schema.json'
...
class TaxGateResultV1:
    ...
    @classmethod
    def from_dict(cls, obj: dict[str, Any]) -> 'TaxGateResultV1':
    ...
    @classmethod
    def load_file(cls, path: str | Path) -> 'TaxGateResultV1':
