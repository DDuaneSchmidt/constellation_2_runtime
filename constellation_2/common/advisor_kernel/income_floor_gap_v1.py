...
SCHEMA_RELPATH = 'governance/04_DATA/SCHEMAS/C2/ADVISOR_KERNEL/income_floor_gap.v1.schema.json'
...
class IncomeFloorGapV1:
    ...
    @classmethod
    def from_dict(cls, obj: dict[str, Any]) -> 'IncomeFloorGapV1':
    ...
    @classmethod
    def load_file(cls, path: str | Path) -> 'IncomeFloorGapV1':
