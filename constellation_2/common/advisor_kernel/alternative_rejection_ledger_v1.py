...
SCHEMA_RELPATH = 'governance/04_DATA/SCHEMAS/C2/ADVISOR_KERNEL/alternative_rejection_ledger.v1.schema.json'
...
class AlternativeRejectionLedgerV1:
    schema_id: str
    schema_version: str
    authority_class: str
    support_status: str
    ...
    rejected_alternatives: tuple[Any, ...]

    @classmethod
    def from_dict(cls, obj: dict[str, Any]) -> 'AlternativeRejectionLedgerV1':
        ...
        return cls(
            ...
            rejected_alternatives=tuple(obj['rejected_alternatives']),
        )

    @classmethod
    def load_file(cls, path: str | Path) -> 'AlternativeRejectionLedgerV1':
