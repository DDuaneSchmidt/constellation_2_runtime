...
SCHEMA_RELPATH = 'governance/04_DATA/SCHEMAS/C2/ADVISOR_KERNEL/missing_input_priority.v1.schema.json'
...
class MissingInputPriorityV1:
    ...
    prioritized_inputs: tuple[Any, ...]

    @classmethod
    def from_dict(cls, obj: dict[str, Any]) -> 'MissingInputPriorityV1':
        ...
        return cls(
            ...
            prioritized_inputs=tuple(obj['prioritized_inputs']),
        )

    @classmethod
    def load_file(cls, path: str | Path) -> 'MissingInputPriorityV1':
    ...
    def to_dict(self) -> dict[str, Any]:
        obj = {
            ...
            'prioritized_inputs': list(self.prioritized_inputs),
        }
        validate_against_repo_schema_v1(obj, REPO_ROOT, SCHEMA_RELPATH)
        return obj
