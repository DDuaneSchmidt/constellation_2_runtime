...
SCHEMA_RELPATH = 'governance/04_DATA/SCHEMAS/C2/ADVISOR_KERNEL/household_timeline.v1.schema.json'
...
class HouseholdTimelineV1:
    ...
    phase_rules_applied: tuple[Any, ...]

    @classmethod
    def from_dict(cls, obj: dict[str, Any]) -> 'HouseholdTimelineV1':
        ...
        return cls(
            ...
            milestones=tuple(obj['milestones']),
            phase_rules_applied=tuple(obj['phase_rules_applied']),
        )

    @classmethod
    def load_file(cls, path: str | Path) -> 'HouseholdTimelineV1':
    ...
    def to_dict(self) -> dict[str, Any]:
        obj = {
            ...
            'phase_rules_applied': list(self.phase_rules_applied),
        }
        validate_against_repo_schema_v1(obj, REPO_ROOT, SCHEMA_RELPATH)
        return obj
