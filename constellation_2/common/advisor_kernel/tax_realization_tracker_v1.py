...
SCHEMA_RELPATH = 'governance/04_DATA/SCHEMAS/C2/ADVISOR_KERNEL/tax_realization_tracker.v1.schema.json'
...
class TaxRealizationTrackerV1:
    ...
    @classmethod
    def from_dict(cls, obj: dict[str, Any]) -> 'TaxRealizationTrackerV1':
    ...
    @classmethod
    def load_file(cls, path: str | Path) -> 'TaxRealizationTrackerV1':
