...
SCHEMA_RELPATH = 'governance/04_DATA/SCHEMAS/C2/ADVISOR_KERNEL/decision_memo.v1.schema.json'
...
class DecisionMemoV1:
    ...
    memo_sections: tuple[Any, ...]
    source_refs: tuple[Any, ...]

    @classmethod
    def from_dict(cls, obj: dict[str, Any]) -> 'DecisionMemoV1':
        ...
        return cls(
            ...
            memo_sections=tuple(obj['memo_sections']),
            source_refs=tuple(obj['source_refs']),
        )

    @classmethod
    def load_file(cls, path: str | Path) -> 'DecisionMemoV1':
