...
SCHEMA_RELPATH = 'governance/04_DATA/SCHEMAS/C2/ADVISOR_KERNEL/income_source_activation_rule.v1.schema.json'
...
class IncomeSourceActivationRuleV1:
    schema_id: str
    schema_version: str
    authority_class: str
    support_status: str
    ...
    @classmethod
    def from_dict(cls, obj: dict[str, Any]) -> 'IncomeSourceActivationRuleV1':
    ...
    @classmethod
    def load_file(cls, path: str | Path) -> 'IncomeSourceActivationRuleV1':
