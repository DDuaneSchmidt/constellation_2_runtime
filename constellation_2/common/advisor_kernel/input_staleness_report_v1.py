...
SCHEMA_RELPATH = 'governance/04_DATA/SCHEMAS/C2/ADVISOR_KERNEL/input_staleness_report.v1.schema.json'
...
class InputStalenessReportV1:
    ...
    @classmethod
    def from_dict(cls, obj: dict[str, Any]) -> 'InputStalenessReportV1':
    ...
    @classmethod
    def load_file(cls, path: str | Path) -> 'InputStalenessReportV1':
