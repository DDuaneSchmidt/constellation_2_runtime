...
SCHEMA_RELPATH = 'governance/04_DATA/SCHEMAS/C2/ADVISOR_KERNEL/income_timeline.v1.schema.json'
...
class IncomeTimelineV1:
    ...
    @classmethod
    def from_dict(cls, obj: dict[str, Any]) -> 'IncomeTimelineV1':
    ...
    @classmethod
    def load_file(cls, path: str | Path) -> 'IncomeTimelineV1':
