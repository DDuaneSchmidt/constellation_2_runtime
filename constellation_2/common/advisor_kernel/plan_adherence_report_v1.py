...
SCHEMA_RELPATH = 'governance/04_DATA/SCHEMAS/C2/ADVISOR_KERNEL/plan_adherence_report.v1.schema.json'
...
class PlanAdherenceReportV1:
    ...
    @classmethod
    def from_dict(cls, obj: dict[str, Any]) -> 'PlanAdherenceReportV1':
    ...
    @classmethod
    def load_file(cls, path: str | Path) -> 'PlanAdherenceReportV1':
