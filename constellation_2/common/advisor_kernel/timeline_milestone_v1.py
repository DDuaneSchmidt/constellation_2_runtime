...
SCHEMA_RELPATH = 'governance/04_DATA/SCHEMAS/C2/ADVISOR_KERNEL/timeline_milestone.v1.schema.json'
...
class TimelineMilestoneV1:
    ...
    @classmethod
    def from_dict(cls, obj: dict[str, Any]) -> 'TimelineMilestoneV1':
    ...
    @classmethod
    def load_file(cls, path: str | Path) -> 'TimelineMilestoneV1':
