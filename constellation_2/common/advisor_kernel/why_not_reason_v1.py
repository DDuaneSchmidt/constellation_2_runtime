...
SCHEMA_RELPATH = 'governance/04_DATA/SCHEMAS/C2/ADVISOR_KERNEL/why_not_reason.v1.schema.json'
...
class WhyNotReasonV1:
    ...
    why_not_reasons: tuple[Any, ...]

    @classmethod
    def from_dict(cls, obj: dict[str, Any]) -> 'WhyNotReasonV1':
        ...
        return cls(
            ...
            why_not_reasons=tuple(obj['why_not_reasons']),
        )

    @classmethod
    def load_file(cls, path: str | Path) -> 'WhyNotReasonV1':
